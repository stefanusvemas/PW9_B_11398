        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#">Buku Saya <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('buku.create') }}" type="button" class="btn btn-success">Tambah Buku</a>
                            ...
                            <table class="table mt-4 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->status}}</td>
                                        <td>
                                            <a href="{{ route('buku.edit', $item->id) }}" onclick="return confirm('Apakah Anda yakin ingin mengedit item ini?')">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <form action="{{ route('buku.destroy', $item->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm text-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus item ini?')">
