        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#">Pinjam <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                            ...
                            <table class="table mt-4 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->judul}}</td>
                                        <td>{{$item->penulis}}</td>
                                        <td>{{$item->penerbit->username}}</td>
                                        <td>
                                            <form action="{{ route('pinjam_buku.store') }}" method="POST" class="d-inline">
                                                @csrf
                                                <input type="hidden" name="id_buku" value={{ $item->id }}>

                                                <button type="submit" class="btn text-primary" onclick="return confirm('Apakah Anda yakin ingin meminjam buku ini?')"><i class="fa fa-plus"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                    @empty
